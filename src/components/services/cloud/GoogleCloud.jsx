...
const GoogleCloud = () => {
  ...
  const [inquiryType, setInquiryType] = useState('Google Cloud Services');

  // Function to open form with specific service type
  const openInquiryForm = (serviceType) => {
    setInquiryType(`Google Cloud - ${serviceType}`);
    setShowForm(true);
  };
  ...
  return (
    <>
      <SEO
        title="Google Cloud Services | CloudDigify"
        description="Accelerate innovation with Google Cloud solutions for data, AI, and scalable infrastructure."
        canonicalUrl="https://clouddigify.com/services/cloud/googlecloud"
        keywords={['Google Cloud', 'cloud services', 'GCP', 'CloudDigify']}
      />
            ...
            >
              <div className="max-w-3xl backdrop-blur-sm bg-white/10 p-8 rounded-2xl">
                ...
                <p className="text-xl text-white/90 mb-8 leading-relaxed">
                  Transform your business with Google Cloud Platform - the enterprise-grade cloud computing solution with AI-powered innovations.
                </p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
