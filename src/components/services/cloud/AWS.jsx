...
const AWS = () => {
  ...
  return (
    <>
      <SEO
        title="AWS Cloud Services | CloudDigify"
        description="Leverage AWS cloud solutions for scalable, secure, and innovative business transformation."
        canonicalUrl="https://clouddigify.com/services/cloud/aws"
        keywords={['AWS', 'cloud services', 'amazon web services', 'CloudDigify']}
      />
