...
const Azure = () => {
  ...
  return (
    <>
      <SEO
        title="Azure Cloud Services | CloudDigify"
        description="Empower your business with Microsoft Azure cloud solutions for agility, security, and innovation."
        canonicalUrl="https://clouddigify.com/services/cloud/azure"
        keywords={['Azure', 'cloud services', 'microsoft azure', 'CloudDigify']}
      />
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-100">
                        ...
                        <p className="text-sm font-medium text-blue-600 mt-1">{stat.achievement}</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
