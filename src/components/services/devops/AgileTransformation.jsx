...
const AgileTransformation = () => {
  ...
  return (
    <>
      <SEO
        title="Agile Transformation Services | CloudDigify"
        description="Accelerate your DevOps journey with Agile Transformation services from CloudDigify."
        canonicalUrl="https://clouddigify.com/services/devops/agile-transformation"
        keywords={['agile transformation', 'DevOps', 'CloudDigify']}
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
