...
const ServerlessArchitecture = () => {
  ...
  return (
    <>
      <SEO
        title="Serverless Architecture Services | CloudDigify"
        description="Build scalable, event-driven applications with serverless architecture solutions from CloudDigify."
        canonicalUrl="https://clouddigify.com/services/devops/serverless-architecture"
        keywords={['serverless', 'DevOps', 'cloud functions', 'CloudDigify']}
      />
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
