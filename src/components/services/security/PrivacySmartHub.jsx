...
const PrivacySmartHub = () => {
  ...
  return (
    <>
      <SEO
        title="Privacy Management Services | CloudDigify"
        description="Transform privacy compliance into a strategic advantage with CloudDigify's PrivacySmartHub: data protection, consent, compliance, and more."
        canonicalUrl="https://clouddigify.com/services/security/privacy-smart-hub"
        keywords={['privacy management', 'data protection', 'compliance', 'CloudDigify']}
      />
