...
const CyberDefence = () => {
  ...
  return (
    <>
      <SEO
        title="Cyber Defence Services | CloudDigify"
        description="Protect your business with CloudDigify's enterprise cyber defence solutions: threat protection, monitoring, compliance, and more."
        canonicalUrl="https://clouddigify.com/services/security/cyber-defence"
        keywords={['cyber defence', 'cybersecurity', 'threat protection', 'CloudDigify']}
      />
