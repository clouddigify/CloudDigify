...
export default function InfrastructureServices() {
  ...
  return (
    <>
      <SEO
        title="Infrastructure Services | CloudDigify"
        description="Build resilient, scalable, and secure infrastructure with CloudDigify's enterprise solutions for compute, storage, network, and compliance."
        canonicalUrl="https://clouddigify.com/services/infrastructure"
        keywords={['infrastructure', 'cloud infrastructure', 'enterprise IT', 'CloudDigify']}
      />
