...
const Strategy = () => {
  ...
  return (
    <>
      <SEO
        title="Digital Strategy Services | CloudDigify"
        description="Transform your business with CloudDigify's digital strategy services: innovation, cloud, automation, and more."
        canonicalUrl="https://clouddigify.com/services/strategy"
        keywords={['digital strategy', 'cloud strategy', 'automation', 'CloudDigify']}
      />
