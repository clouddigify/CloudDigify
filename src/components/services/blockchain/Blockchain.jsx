...
const Blockchain = () => {
  ...
  return (
    <>
      <SEO
        title="Blockchain Services | CloudDigify"
        description="Secure, scalable, and efficient blockchain solutions for enterprise. Transform your business with CloudDigify's distributed ledger technology."
        canonicalUrl="https://clouddigify.com/services/blockchain"
        keywords={['blockchain', 'distributed ledger', 'enterprise blockchain', 'CloudDigify']}
      />
