...
const MLOps = () => {
  ...
  return (
    <>
      <SEO
        title="MLOps Services | CloudDigify"
        description="Streamline your machine learning lifecycle with CloudDigify's MLOps solutions for scalable, reliable AI deployment."
        canonicalUrl="https://clouddigify.com/services/ai/mlops"
        keywords={['mlops', 'machine learning operations', 'ai deployment', 'CloudDigify']}
      />
