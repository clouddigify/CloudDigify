...
const RPA = () => {
  ...
  return (
    <>
      <SEO
        title="Robotic Process Automation (RPA) Services | CloudDigify"
        description="Automate repetitive business processes with CloudDigify's RPA solutions for efficiency, accuracy, and cost savings."
        canonicalUrl="https://clouddigify.com/services/ai/rpa"
        keywords={['rpa', 'robotic process automation', 'automation', 'CloudDigify']}
      />
