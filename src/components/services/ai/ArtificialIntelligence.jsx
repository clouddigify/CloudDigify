...
const ArtificialIntelligence = () => {
  ...
  return (
    <>
      <SEO
        title="Artificial Intelligence Services | CloudDigify"
        description="Transform your business with CloudDigify's artificial intelligence solutions for automation, analytics, and innovation."
        canonicalUrl="https://clouddigify.com/services/ai/artificial-intelligence"
        keywords={['artificial intelligence', 'ai', 'automation', 'CloudDigify']}
      />
