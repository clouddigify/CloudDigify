...
const OracleCloudTraining = () => {
  ...
  return (
    <>
      <SEO
        title="Oracle Cloud Training | CloudDigify"
        description="Master Oracle Cloud Infrastructure with CloudDigify's official curriculum, hands-on labs, and certification support."
        canonicalUrl="https://clouddigify.com/training/oracle-cloud"
        keywords={['Oracle Cloud training', 'OCI certification', 'CloudDigify']}
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
