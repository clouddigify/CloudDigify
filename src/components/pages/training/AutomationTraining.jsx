...
const AutomationTraining = () => {
  ...
  return (
    <>
      <SEO
        title="Automation Tools Training | CloudDigify"
        description="Boost your productivity with CloudDigify's automation tools training. Hands-on labs, real projects, and industry best practices."
        canonicalUrl="https://clouddigify.com/training/automation"
        keywords={['automation training', 'RPA', 'CI/CD', 'CloudDigify']}
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
