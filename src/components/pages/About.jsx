...
const About = () => (
  <div className="bg-gray-50">
    ...
    {/* Hero Section */}
    <section className="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-800 text-white flex items-center justify-center" style={{ minHeight: '260px' }}>
      <div className="max-w-3xl mx-auto px-4 flex flex-col items-center justify-center text-center">
        <h1 className="text-5xl md:text-6xl font-extrabold mb-2">About CloudDigify</h1>
    ...
    {/* Spacer between Hero and Who We Are */}
