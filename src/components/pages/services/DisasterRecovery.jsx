...
const DisasterRecovery = () => {
  const pageInfo = {
    ...
    overviewDescription1: "In today's digital business environment, downtime and data loss can have severe consequences. Disaster recovery planning is essential to minimize the impact of unplanned outages and ensure quick recovery from disruptions.",
    overviewDescription2: "Our cloud-based disaster recovery solutions offer robust protection for your business-critical systems and data, with flexible recovery options tailored to your specific business requirements and budget constraints.",
    benefits: [
    ...
    secondaryCta: "Schedule DR Assessment",
    featuresTitle: "Our Disaster Recovery Services",
    featuresDescription: "Comprehensive disaster recovery solutions to protect your business from disruptions.",
    features: [
      {
    ...
    technologiesDescription: "We leverage industry-leading technologies to implement robust disaster recovery solutions.",
    technologiesUsed: [
      "AWS Backup",
      "Azure Site Recovery",
      "Google Cloud Backup",
    ...
    finalCta: "Schedule DR Consultation"
  };
