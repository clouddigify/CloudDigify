...
const Healthcare = () => {
  ...
  return (
    <>
      <SEO
        title="Healthcare Industry Solutions | CloudDigify"
        description="Transform healthcare with CloudDigify's AI diagnostics, secure data management, and patient care analytics solutions."
        canonicalUrl="https://clouddigify.com/industries/healthcare"
        keywords={['healthcare', 'AI diagnostics', 'patient care', 'CloudDigify']}
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
