...
const ElectricalEquipment = () => {
  ...
  return (
    <>
      <SEO
        title="Electrical Equipment Industry Solutions | CloudDigify"
        description="Empower your electrical equipment business with CloudDigify's IoT, automation, and digital transformation solutions."
        canonicalUrl="https://clouddigify.com/industries/electrical-equipment"
        keywords={['electrical equipment', 'automation', 'IoT', 'CloudDigify']}
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
