...
const ResearchAdvisory = () => {
  ...
  return (
    <>
      <SEO
        title="Research & Advisory Solutions | CloudDigify"
        description="Leverage CloudDigify's AI-powered research, analytics, and strategic advisory for data-driven decisions."
        canonicalUrl="https://clouddigify.com/industries/research-advisory"
        keywords={['research', 'advisory', 'analytics', 'AI', 'CloudDigify']}
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
