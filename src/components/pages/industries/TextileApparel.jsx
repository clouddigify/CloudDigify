...
const TextileApparel = () => {
  ...
  return (
    <>
      <SEO
        title="Textile & Apparel Industry Solutions | CloudDigify"
        description="Modernize textile and apparel manufacturing with CloudDigify's IoT, automation, and supply chain solutions."
        canonicalUrl="https://clouddigify.com/industries/textile-apparel"
        keywords={['textile', 'apparel', 'IoT', 'automation', 'CloudDigify']}
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
