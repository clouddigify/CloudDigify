...
const Contact = () => {
  ...
  return (
    <>
      <SEO
        title="Contact Us | CloudDigify"
        description="Get in touch with CloudDigify for cloud, DevOps, and digital transformation services. We're here to help you succeed."
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-gray-600">Plot No GH-02/A, Sector 16, Vaidpura, Greater Noida, Uttar Pradesh 201309</p>
                    </div>
                  </div>
